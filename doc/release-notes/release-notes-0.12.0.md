Shirecoin Core version 0.12.0 is now available from:
  ...
  <https://shirecoin.org/bin/shirecoin-core-0.12.0/>
...
notes of v0.11.0](https://github.com/shirecoin/shirecoin/blob/v0.11.0/doc/release-notes.md#block-file-pruning).
