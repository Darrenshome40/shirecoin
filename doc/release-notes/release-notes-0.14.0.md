Shirecoin Core version 0.14.0 is now available from:
  ...
  <https://shirecoin.org/bin/shirecoin-core-0.14.0/>
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/shirecoin/shirecoin/blob/master/doc/zmq.md) for
...
The Alert System was [disabled and deprecated](https://shirecoin.org/en/alert/2016-11-01-alert-retirement) in Shirecoin Core 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   ...
   optimizations to memory management. See [Pull #8753](https://github.com/shirecoin/shirecoin/pull/8753)
