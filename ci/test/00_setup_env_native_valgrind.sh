#!/usr/bin/env bash
#
# Copyright (c) 2019 The Shirecoin Core developers
...
export NO_DEPENDS=1
export TEST_RUNNER_EXTRA="--exclude rpc_bind"  # Excluded for now, see https://github.com/shirecoin/shirecoin/issues/17765#issuecomment-602068547
export GOAL="install"
