// Copyright (c) 2011-2020 The Shirecoin Core developers
...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", ShirecoinUnits::BTC);
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/shirecoin/shirecoin/pull/8273
