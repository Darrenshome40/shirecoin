...
// Copyright (c) 2009-2020 The Shirecoin Core developers
...
bool CWallet::AddToWallet(const CWalletTx& wtxIn, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/shirecoin/shirecoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/shirecoin/shirecoin/pull/13339#issuecomment-461288094
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/shirecoin/shirecoin/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/shirecoin/shirecoin/pull/9371 and the prior sync
    ...
    while (block_height && !fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
            ...
            if (!locked_chain->getBlockHeight(block_hash)) {
                ...
                // https://github.com/shirecoin/shirecoin/pull/14711#issuecomment-458342518
 ...
 * https://github.com/shirecoin/shirecoin/pull/1393.
 */
